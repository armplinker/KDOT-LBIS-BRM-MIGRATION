...
prompt List generated with SQL> select t.*, t.rowid from PON_FILTERS t where t.filterkey > 15000 and shared=1 and accessfilter=0 and lower(context)='inspection' order by 1
...
values (16501, '1', 'LBIS Condition summary', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.brkey,
       b.bridge_id,
       v.lpa_bridge_id,
...
insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16502, '1', 'LBIS Material and Type of Main Span', 0, 1, 'Inspection', q'[SELECT
b.bridge_gd AS key_,
b.Brkey,
...
insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16505, '1', q'[LBIS Bridges with under roadways]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_
      ,b.Brkey 
      ,b.Bridge_Id    AS Bridge_Id
      ,b.Strucname  AS Lpa_Bridge_Id
 ...
 WHERE Pc.Table_Name = 'bridge'
   ...
   AND (1 = 1)
   ORDER BY 1]', 'Bridges with under roadways', 2, null, 1, 'F', '5A7A2FA3F55B4E04A8C8630AB82C6EC5', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:30', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16506, '1', 'LBIS * Default', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.Bridge_Id   AS Bridge_Id,
       b.Strucname   AS Lpa_Bridge_Id,
...
insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16508, '1', 'LBIS Bridges with expired sufficiency ratings', 0, 1, 'Inspection', q'[SELECT b.bridge_gd as key_,
       b.brkey,
 ...
 AND (1 = 1)
 ORDER BY 1]', q'[Bridges with expired sufficiency ratings]', 2, null, 1, 'F', '6DF3283D32E449BE913320C80D727961', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:30', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16509, '1', q'[LBIS Bridges with no inspections]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.bridge_id  AS Bridge_ID,
       b.strucname  as LPA_Bridge_ID,
 ...
 WHERE pc.table_name = 'bridge'
   ...
   AND (1 = 1)
 ORDER BY 1]', q'[Bridges with no inspections]', 2, null, 1, 'F', 'CEA49B55BF344582BF3B31919CBD66C1', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:30', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16510, '1', q'[LBIS Inspector and latest inspection date]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.strucname  as LPA_Bridge_ID,
 ...
 WHERE pc.table_name = 'bridge'
   ...
   AND (1 = 1)
   ORDER BY 1]', q'[Inspector and inspection date]', 2, null, 1, 'F', 'A45D15BED9FE4CD8AE50AF42B7407F21', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:30', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16512, '1', q'[LBIS Bridges with QCQA inspections]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.bridge_id          AS Bridge_ID,
       b.strucname          as LPA_Bridge_ID,
  ...
  ON (b.bridge_gd=v.bridge_gd)
  WHERE (1 = 1)
  ORDER BY 1]', q'[Bridges with QCQA inspections showing data comparisons]', 2, null, 1, 'F', '870EF7B5D9EC40E6BFF0DFCE6F25BE49', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:30', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16514, '1', q'[LBIS Bridges with locked inspections]', 0, 1, 'Inspection', q'[SELECT b.bridge_gd  AS key_,
       b.Brkey,
       b.bridge_id  AS Bridge_ID,
       b.strucname  as LPA_Bridge_ID,
       pd.shortdesc as District,
 ...
 WHERE (pc.table_name = 'bridge' AND pc.field_name = 'county' AND
       ...
       exists (SELECT 1
                ...
                where i.BRKEY = b.Brkey
                  and i.inspstat = '4'))
   AND (1 = 1)
 ORDER BY 1]', q'[Locked bridges w/ Inspector and inspection date]', 2, null, 1, 'F', '066F20917C574969B0EE18F1F9F37898', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:30', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16515, '1', q'[LBIS Bridges with Annual Routine Inspection]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       ...
       (select max(j.inspkey)
          ...
          where j.brkey = b.Brkey
            and j.inspdate = (select max(k.inspdate)
                               ...
                               where k.brkey = b.Brkey)))
  AND (1 = 1)
  ORDER BY 1]', q'[Bridges with Annual Inspections]', 2, null, 1, 'F', '83A27DA1EF1C408C8615A78095BEA602', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:30', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16556, null, 'LBIS Bridges changed or created today', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.Bridge_Id   AS Bridge_Id,
       b.Strucname   AS Lpa_Bridge_Id,
...
insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16611, '1', 'LBIS Structures with fracture critical reports', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd   AS key_,
       b.Brkey,
       b.bridge_id   AS Bridge_ID,
       b.strucname   as LPA_Bridge_ID,
 ...
 WHERE pc.table_name = 'bridge'
   ...
   AND EXISTS (SELECT 1
         ...
         WHERE brkey = b.Brkey
           AND doc_type_key = '11')
   AND (1 = 1)
   ORDER BY 1]', q'[Structures with fracture critical reports]', 2, null, 1, 'F', 'C609E585BB8246E6965C9346823AD042', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:30', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16612, '1', 'LBIS Structures with underwater inspection reports', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd   AS key_,
       b.Brkey,
       b.bridge_id   AS Bridge_ID,
       b.strucname   as LPA_Bridge_ID,
 ...
 WHERE pc.table_name = 'bridge'
   ...
   AND EXISTS (SELECT 1
         ...
         WHERE brkey = b.Brkey
           AND doc_type_key = '12')
   AND (1 = 1)
   ORDER BY 1]', q'[Structures with underwater inspection reports]', 2, null, 1, 'F', 'FD36CAFA12C348718174A6AB261B16D6', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:30', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16613, '1', 'LBIS Structures with special inspection reports', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd   AS key_,
       b.Brkey,
       b.bridge_id   AS Bridge_ID,
       b.strucname   as LPA_Bridge_ID,
 ...
 WHERE pc.table_name = 'bridge'
   ...
   AND EXISTS (SELECT 1
         ...
         WHERE brkey = b.Brkey
           AND doc_type_key = '13') 
   AND (1 = 1)
   ORDER BY 1]', q'[Structures with special inspection reports]', 2, null, 1, 'F', 'B6FA18E5B91744E3B1E6EEE8C79097A0', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16614, '1', 'LBIS Structures with scour reports', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd   AS key_,
       b.Brkey,
       b.bridge_id   AS Bridge_ID,
       b.strucname   as LPA_Bridge_ID,
 ...
 WHERE pc.table_name = 'bridge'
   ...
   AND EXISTS (SELECT 1
         ...
         WHERE brkey = b.Brkey
           AND doc_type_key = '50')
   AND (1 = 1)
   ORDER BY 1]', q'[Structures with scour reports]', 2, null, 1, 'F', '159543F081AC40EA9934B3708B46EBE4', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16615, '1', 'LBIS Structures with critical inspection findings', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd   AS key_,
       b.Brkey,
       b.bridge_id   AS Bridge_ID,
       b.strucname   as LPA_Bridge_ID,
 ...
 WHERE pc.table_name = 'bridge'
   ...
   AND EXISTS (SELECT 1
         ...
         WHERE brkey = b.Brkey
           AND doc_type_key = '15')
           AND (1 = 1)
             ORDER BY 1]', q'[Structures with critical inspection findings]', 2, null, 1, 'F', '2FE51CBA8D2F466183E14A47663B0B19', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16616, '1', 'LBIS Structures with load ratings forms', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd   AS key_,
       b.Brkey,
       b.bridge_id   AS Bridge_ID,
       b.strucname   as LPA_Bridge_ID,
 ...
 WHERE pc.table_name = 'bridge'
   ...
   AND EXISTS (SELECT 1
         ...
         WHERE kd.bridge_gd = b.bridge_gd
           ...
           AND (1 = 1)
 ORDER BY 1]', q'[Structures with load ratings forms]', 2, null, 1, 'F', '223E43E78E61415987276AF4A6D2A3B8', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16617, '1', q'[LBIS Structures with existing plans]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd   AS key_,
       b.Brkey,
       b.bridge_id   AS Bridge_ID,
       b.strucname   as LPA_Bridge_ID,
 ...
 WHERE pc.table_name = 'bridge'
   ...
   AND EXISTS (SELECT 1
         ...
         WHERE brkey = b.Brkey
           AND doc_type_key = '17')
 AND (1 = 1)
 ORDER BY 1]', q'[Structures with existing plans]', 2, null, 1, 'F', 'B870D3EB548B45D5B6F5C1FE6A789985', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16711, '1', q'[LBIS * Structures with FC inspections]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd   AS key_,
       b.Brkey,
       b.Bridge_Id AS Bridge_Id,
       b.Strucname AS Lpa_Bridge_Id,
 ...
 INNER JOIN (SELECT * FROM V_BRIDGES_WITH_FC_INSPECTIONS ) vu
  ...
  WHERE LOWER(TRIM(b.bridgegroup)) NOT IN
   ...
   AND (1 = 1)
 ORDER BY 1]', q'[Structures with FC inspections]', 2, null, 1, 'F', '7D8F54EA7C2C4235966ABBBDE66E1459', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16712, '1', 'LBIS * Structures with UW inspections', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd   AS key_,
       b.Brkey,
       b.Bridge_Id AS Bridge_Id,
       b.Strucname AS Lpa_Bridge_Id,
 ...
 INNER JOIN (SELECT * FROM V_BRIDGES_WITH_UW_INSPECTIONS ) vu
  ...
  WHERE LOWER(TRIM(b.bridgegroup)) NOT IN
       (SELECT LOWER(TRIM(keb.bridgegroup)) FROM KDOTBLP_EXCLUDED_BRIDGEGROUPS keb)
   AND (1 = 1)
 ORDER BY 1]', q'[Structures with UW inspections]', 2, null, 1, 'F', '370A3C8AC6A846A7B1B7802952F5E1AC', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16713, '1', q'[LBIS * Structures with OS inspections]', 0, 1, 'Inspection', q'[SELECT b.bridge_gd AS key_,
       b.Brkey,
       b.Bridge_Id AS Bridge_Id,
       b.Strucname AS Lpa_Bridge_Id,
       b.Featint AS Feature_Intersected,
 ...
 WHERE LOWER(TRIM(b.bridgegroup)) NOT IN
   ...
   AND (1 = 1)
 ORDER BY 1]', q'[Structures with OS inspections]', 2, null, 1, 'F', 'BEA9B2DB4A864B528C4DFE99708D5CFC', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16715, '5868', q'[Local - Railroads]', 0, 1, 'inspection', null, q'[Owner or Custodian = RailRoad (27)]', 1, q'[where bridge.owner in ('27') and bridge.custodian in ('27')]', 0, 'F', '390E370F282744BDAD60AA0AEE9331CC', '84A15942D4B749EF9C7A0AAC460081AE', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16750, '1', q'[LBIS - FC Ever Required Since 2012]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.Bridge_Id AS Bridge_Id,
       b.Strucname AS Lpa_Bridge_Id,
 ...
 INNER JOIN v_Fc_Ever_Reqd_Since_2012 v
    ON b.Bridge_Gd = v.Bridge_Gd
 WHERE (1 = 1)
 ORDER BY 1]', q'[Shows bridges where a FC inspection was ever required since 2012]', 2, null, 1, 'F', '416CD39900C946209C3890F0A61BE762', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16751, '1', 'LBIS - NBI Export', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.Bridge_Id AS Bridge_Id,
       f_lbl(b.district, 'bridge', 'district') AS District,
 ...
 WHERE LOWER(TRIM(b.bridgegroup)) NOT IN
   ...
   AND (1 = 1)
 ORDER BY 1]', q'[NBI export filter to remove Bridge Groups that we don't submit]', 2, null, 1, 'F', 'F648101991FB42018A21F019C242EC2F', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16753, '1', q'[LBIS - Off System Bridges]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.bridge_id  AS Bridge_ID,
       b.strucname  AS LPA_Bridge_ID,
 ...
 WHERE pc.table_name = 'bridge'
   ...
   AND (1 = 1)
   ORDER BY 1]', q'[Off System Bridge List 2017]', 2, null, 1, 'F', '0AE94C7B91834E47B9CCB3D4357F6035', 'B330B38925654E468AE8E883F62A0E82', null, null, null, null, 0, 0);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16754, '1', q'[LBIS - Border Bridges Nebraska]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.bridge_id,
       EXTB.agency,
 ...
 AND (1 = 1)
 ORDER BY 1]', q'[Nebraska Border Bridges]', 2, null, 1, 'F', '6F3CE058AC834335BA02B096E1B65F04', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16755, '1', q'[LBIS - Border Bridges Oklahoma]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.bridge_id,
       EXTB.agency,
 ...
 AND (1 = 1)
 ORDER BY 1]', q'[Oklahoma Border Bridges]', 2, null, 1, 'F', '92769801049542269CD5E198F93CF18E', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16756, '1', q'[LBIS - Border Bridges Missouri]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.bridge_id,
       EXTB.agency,
 ...
 AND (1 = 1)
 ORDER BY 1]', q'[Missouri Border Bridges]', 2, null, 1, 'F', '363224A019434664939BCBC290F4D893', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16781, '1', q'[LBIS - NBI Export - TESTING]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd as key_,
       b.brkey,
       b.Bridge_Id AS Bridge_Id,
       f_lbl(b.district, 'bridge', 'district') AS District,
...
insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16785, '1', q'[LBIS - Bridges with load rating data]', 0, 1, 'Inspection', q'[SELECT b.bridge_gd                AS key_,
       b.Brkey,
       b.bridge_id                "Bridge ID",
...
insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16790, '1', q'[LBIS - Find-A-Bridge List]', 0, 1, 'Inspection', q'[SELECT
       b.bridge_gd AS key_,
       b.Brkey,
       b.bridge_gd,
       b.Bridge_Id      AS Bridge_Id,
 ...
 INNER JOIN Inspevnt i
    ON i.INSPEVNT_GD = mv.INSPEVNT_GD
 AND (1 = 1)    
 ORDER BY 1]', q'[bridge_gd is shown at the start of the result row so the field can be used to look up bridges by BRIDGE_GD]', 1, null, 1, 'F', '44B9EDC6ABE446D38E529AA2C2F4E3C6', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16791, '1', q'[LBIS - Pin and Hanger Contract Bridges]', 0, 1, 'Inspection', null, q'[Pin & Hanger contract bridges]', 2, q'[where bridge.userkey6 = '0']', 1, 'F', 'D171102CD8A6429EB59C686E062704E1', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);

insert into PON_FILTERS (FILTERKEY, USERKEY, NAME, ACCESSFILTER, SHARED, CONTEXT, SQL_FILTER, NOTES, FILTER_TYPE, WHERE_CLAUSE, EDITED_MANUALLY, PONTIS_STANDARD_IND, PON_FILTERS_GD, PON_APP_USERS_GD, SQL_ORDERBY, CREATEUSERKEY, CREATEDATETIME, MODTIME, GROUP_SHARED, ISACTIVE)
values (16795, '1', q'[LBIS - Bridges with problematic BRIDGEGROUP]', 0, 1, 'Inspection', q'[SELECT b.bridge_gd AS key_,
       b.brkey,
       b.bridge_id AS bridge_id,
       b.strucname AS lpa_bridge_id,
       b.bridgegroup AS bridge_group,
       b.createDateTime,
       CASE
         WHEN Trunc(b.modtime) >= Add_months(SYSDATE, -12) THEN
          'Due for assignment by modification date '
         ELSE
          CASE
            WHEN Trunc(b.createdatetime) >= Add_months(SYSDATE, -12) THEN
            '[Due for assignment by create date'
            ELSE
             NULL
          END
       END as OVERDUE,
 ...
 WHERE Lower(Trim(b.bridgegroup)) = 'unassigned'
    OR ((Trunc(b.createdatetime) >= Add_months(SYSDATE, -12) OR
        ...
        ((b.bridgegroup IS NULL OR Lower(Trim(b.bridgegroup)) = '') OR
 ...
 AND (1 = 1)             
 ORDER BY 1]', q'[Shows any bridges with a questionable BRIDGEGROUP value - NULL, blank, -1 or does not exist in PARAMTRS]', 1, null, 1, 'F', '2ED874CCDA774E3ABAD667FA2B26ADC5', 'B330B38925654E468AE8E883F62A0E82', null, null, null, to_date('12-01-2023 12:44:31', 'dd-mm-yyyy hh24:mi:ss'), 0, 1);
